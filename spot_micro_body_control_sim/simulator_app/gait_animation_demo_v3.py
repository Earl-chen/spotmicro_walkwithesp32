#!/usr/bin/env python3
# gait_animation_demo_v3.py - 步态动画演示（修复初始姿态）
...
def main():
    ...
    def update(frame):
        ...
        controller.set_body_pose(
            ...
            0, body_z, 0, 0, 0,  # Y, Z, Roll, Pitch, Yaw
            radians=True
        )
    ...
    # 保存动画
    output_path = os.path.join(os.path.dirname(__file__), 'gait_animation_demo_v3.gif')
    print(f"\n正在保存动画到: {output_path}")
