#!/usr/bin/env python3
# plot_trajectory_simple.py - 简化版轨迹绘制（确保中文字体）
...
ax3.set_xlabel('X偏移 (cm)')
ax3.set_ylabel('Z偏移 (cm)')
ax3.set_title('足端2D轨迹（圆点=起点）')
ax3.legend()
...
# 保存图片
output_path = os.path.join(project_root, 'gait_trajectory_simple.png')
